          ...
          <form onSubmit={handleContactSubmit} className={`space-y-4 ${formStatus.submitted ? 'opacity-50 pointer-events-none' : ''}`}>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-1 flex-grow focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white placeholder-gray-400 disabled:opacity-50 resize-none"
                disabled={formStatus.submitting || formStatus.submitted}
              ></textarea>
            </div>
