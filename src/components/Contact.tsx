...
function Contact() {
  ...
  return (
    <main id="contact" className="section bg-midnight py-20">
      <div className="container-custom grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="flex flex-col space-y-3">
              {linkedInProfiles.map(profile => (
                <a
                  ...
                  className="flex items-center gap-2 text-cyan-400 hover:text-white transition-colors duration-200"
                >
                  <Linkedin size={20} />
                  {profile.name}
                </a>
