...
const teamMembers = [
  { name: "Pranav Adya", title: "Co-Founder", linkedin: "https://www.linkedin.com/in/pranav-adya-999a36272" },
  { name: "Amol Tandon", title: "Co-Founder", linkedin: "https://www.linkedin.com/in/amol-tandon-a11971205" },
...
function Contact() {
  const linkedInProfiles = teamMembers
    .filter(m => m.title !== 'Chief Morale Officer')
  ...
  return (
    <main id="contact-section" className="section bg-midnight pt-20 pb-16">
      <div className="container-custom grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <div className="glass-card p-8 sm:p-10 rounded-xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center md:text-left text-gray-900">Contact Us</h2>
          <div className="mb-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Email Us</h3>
            <a href="mailto:thecollieteam@gmail.com" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-600 text-lg transition-colors duration-200">
              <Mail size={20} />
              thecollieteam@gmail.com
            </a>
            <p className="text-gray-800 text-sm mt-2">We typically respond within 24 hours.</p>
          </div>
          <div className="mb-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Connect on LinkedIn</h3>
            <div className="flex flex-col space-y-3">
              {linkedInProfiles.map(profile => (
                <a
                  ...
                  className="flex items-center gap-2 text-cyan-400 hover:text-cyan-600 transition-colors duration-200"
                >
                  <Linkedin size={20} />
                  {profile.name}
                </a>
          ...
          <div>
            ...
            <p className="text-gray-800">Champaign, IL</p>
          </div>
        </div>

        <div className="glass-card p-8 sm:p-10 rounded-xl h-full flex flex-col justify-center">
          ...
          <form onSubmit={handleContactSubmit} className={`space-y-4 ${formStatus.submitted ? 'opacity-50 pointer-events-none' : ''}`}>
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-white/90 border border-gray-800 rounded-lg pl-10 pr-4 py-3 flex-grow focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 placeholder-gray-700 disabled:opacity-50"
            ...
            <div className="relative">
              ...
              <textarea
                ...
                required
                className="w-full bg-white/90 border border-gray-800 rounded-lg pl-10 pr-4 py-2 flex-grow focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 placeholder-gray-700 disabled:opacity-50 resize-none"
                disabled={formStatus.submitting || formStatus.submitted}
              ></textarea>
            </div>
            <div className="text-center pt-2">
              <button
                type="submit"
                className="btn btn-primary px-8 py-3 rounded-xl shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
                disabled={formStatus.submitting || formStatus.submitted}
              >
